...
public class MegaPlayerWrap extends APiece implements  Player {
    private Player p;
    private boolean isMega;

    public MegaPlayerWrap(Player p) {
        super(p.getName(),"MegaGraninja.png");
        this.p = p;
        isMega = false;
    }
    ...
    public void applyBuff() {
        Thread MegaPlayer = new Thread(() ->{
            if (p.getMegaEnergyBar() >= 100){isMega = true;}
